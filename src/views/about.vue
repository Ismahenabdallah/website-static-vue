    ...
    <div class="about">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <hr />
          <p class="p2 text-start text-muted">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Odio
            quidem voluptatum vel laboriosam consequuntur maiores ratione enim
            officia quibusdam ad iste, dolores numquam eos minima, rem nemo
            neque atque commodi!
          </p>
        </div>
      </div>
